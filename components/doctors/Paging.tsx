...
const Paging = ({ doctors, pagination, changePage }: PagingProps) => {
    return (
        doctors &&
        doctors?.length > 0 &&
        pagination?.total > Number(process.env.NEXT_PUBLIC_PAGINATION_LIMIT) && (
            <Pagination>
                <PaginationContent>
                    ...
                    <PaginationItem>
                        <PaginationLink
                            ...
                            className={`cursor-default px-3 py-1 rounded ${pagination.current_page === 1 ? "act text-white pointer-events-none" : "bg-gray-200"
                                }`}
                        >
                            1
                        </PaginationLink>
                            ...
                            return (
                                <PaginationItem key={page}>
                                    <PaginationLink
                                        ...
                                        className={`cursor-default px-3 py-1 rounded ${pagination.current_page === page
                                            ? "act text-white pointer-events-none"
                                            : "bg-gray-200"
                                            }`}
                                    >
                                        {page}
                    ...
                    {pagination.last_page > 1 && (
                        <PaginationItem>
                            <PaginationLink
                                ...
                                className={`cursor-default px-3 py-1 rounded ${pagination.current_page === pagination.last_page
                                    ? "act text-white pointer-events-none"
                                    : "bg-gray-200"
                                    }`}
                            >
