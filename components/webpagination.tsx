...
import { Pagination as Wpagination, ChangePageFn } from '@/components/patients/Types'

export default function WebPagination({ pagination, changePage }: { pagination: Wpagination, changePage: ChangePageFn }) {
    return (
        <Pagination>
            <PaginationContent>
                {pagination.current_page > 1 && (
                    <PaginationItem>
                        <PaginationPrevious
                            className="pagination-prev cursor-default"
